...
# python src/inference_qa.py  --test_file output/chinese-roberta-wwm-ext\mc\test.json --context_file data/context.json --model_name_or_path output/chinese-roberta-wwm-ext/qa --tokenizer_name output/chinese-roberta-wwm-ext/qa  --pad_to_max_length --max_seq_length 512 --per_device_eval_batch_size 100 --output_dir output\chinese-roberta-wwm-ext\qa
# --debug
...
def main():
    ...
    df = pd.DataFrame({
        "id": prediction_id, "answer": prediction_text,
    })
    # ipdb.set_trace()
